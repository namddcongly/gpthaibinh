...
class CategoryRegionModel extends DatabaseObject 
{
	...
	{
		$sql = "SELECT SQL_CALC_FOUND_ROWS a.id,a.cate_id,a.region_id,a.skins_type,a.number_record,a.property,a.arrange,b.name,b.description FROM ".$this->tableName." as a, ".$this->tableRegion." as b WHERE a.region_id=b.id ".($condition != "" ? " AND ".$condition : "").($order != "" ? " ORDER BY $order " : "").($limit != "" ? " LIMIT ".$limit : "");
