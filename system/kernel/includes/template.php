...
class Template {
	...
	function return_skin($target, $handle, $append = false) {
		return $this->parse ( $target, $handle, $append );
	}
	...
	function ftemplate($file, $val = array()) {

		if (! isset ( $imod [$file] )) {
			$this->set_file ( md5 ( $file ), $file );
			$imod [$file] = true;
		}
