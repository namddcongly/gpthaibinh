...
// Images Directory
imagesDir = "webskins/richtext/icons/";

// CSS Directory
cssDir = "webskins/richtext/styles/";

// Popups Directory
popupsDir = "webskins/richtext/popups/";
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      //	window.open('?portal=main&page=image_library&target='+n,'popup','location=0,status=1,scrollbars=1,resizable=1,width=800,height=600');
...
function updateTextArea(n) {
	...
	if (document.getElementById(n).value=='<br>')
	{
