...
//$Config['UserFilesPath'] = $_SESSION['FCKDATA_HTTP'] ;
$Config['UserFilesPath'] = '/data/upload/' ;

// Fill the following value it you prefer to specify the absolute path for the
// user files directory. Useful if you are using a virtual directory, symbolic
// link or alias. Examples: 'C:\\MySite\\userfiles\\' or '/root/mysite/userfiles/'.
// Attention: The above 'UserFilesPath' must point to the same directory.
//$Config['UserFilesAbsolutePath'] = $_SESSION['FCKDATA_PATH'] ;
$Config['UserFilesAbsolutePath'] = preg_replace('#\/#i', DS, $_SERVER['DOCUMENT_ROOT']).DS.'data'.DS.'upload'.DS;// Due to security issues with Apache modules, it is recommended to leave the
// following setting enabled.
$Config['ForceSingleExtension'] = true ;

// Perform additional checks for image files.
// If set to true, validate image size (using getimagesize).
if(intval($_SESSION['logged']["memberid"])){
